...
PhysVehicle3D* ModulePhysics3D::AddVehicle(const VehicleInfo& info)
{
	...
	btCollisionShape* aleronShape = new btBoxShape(btVector3(info.aleron_size.x*0.5f, info.aleron_size.y*0.5f, info.aleron_size.z*0.5f));
	shapes.add(aleronShape);
	...
	btTransform aleron;
	aleron.setIdentity();
	aleron.setOrigin(btVector3(info.aleron_offset.x, info.aleron_offset.y, info.aleron_offset.z));

	comShape->addChildShape(trans, colShape);
	comShape->addChildShape(aleron, aleronShape);
