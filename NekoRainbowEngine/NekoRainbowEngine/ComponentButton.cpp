...
void ComponentButton::Draw()
{
	...
	float3 v1 = float3(comp_canvas_trans->position.x + pos.x, comp_canvas_trans->position.y + pos.y, pos.z);
	float3 v2 = float3(comp_canvas_trans->position.x + pos.x + width, comp_canvas_trans->position.y + pos.y, pos.z);
	float3 v3 = float3(comp_canvas_trans->position.x + pos.x, comp_canvas_trans->position.y + pos.y - height, pos.z);
	float3 v4 = float3(comp_canvas_trans->position.x + pos.x + width, comp_canvas_trans->position.y + pos.y - height, pos.z);
